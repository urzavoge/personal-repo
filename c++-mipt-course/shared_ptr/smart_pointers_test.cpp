...
int main() {
    ...
    assert((!std::is_base_of<std::shared_ptr<VerySpecialType>, SharedPtr<VerySpecialType>>::value));
    
    assert((!std::is_base_of<std::weak_ptr<VerySpecialType>, WeakPtr<VerySpecialType>>::value));
